...
class loginView extends Component {
  ...
  state = {
    ...
    Keyword1:this.props.RootStore.keywords[0]?this.props.RootStore.keywords[0].KeywordContent:'',
    Keyword2:this.props.RootStore.keywords[1]?this.props.RootStore.keywords[1].KeywordContent:'',
    Keyword3:this.props.RootStore.keywords[2]?this.props.RootStore.keywords[2].KeywordContent:'',
  ...
  edit = async()=>{
    ...
    var data = {
      ...
      'keywords':[{'KeywordContent':this.state.Keyword1,'KeywordId':this.props.RootStore.keywords[0]?this.props.RootStore.keywords[0].KeywordId:'new'},
                  {'KeywordContent':this.state.Keyword2,'KeywordId':this.props.RootStore.keywords[1]?this.props.RootStore.keywords[1].KeywordId:'new'},
                  {'KeywordContent':this.state.Keyword3,'KeywordId':this.props.RootStore.keywords[2]?this.props.RootStore.keywords[2].KeywordId:'new'}],
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput style={styles.inputStyle} placeholder={'Edite your Nickname'} underlineColorAndroid={'transparent'}
         keyboardType={'email-address'} value={NickName} onChangeText={(text)=>{
           this.NickNameChange(text)
           //this.props.RootStore.setUserName(text)
           //console.log(this.props.RootStore.UserName)
          //  this.setState({nameCheckIndicator:true,nameCheckLoad:true})
          //  setTimeout(()=>{this.setState({nameCheckLoad:false})},1000)
         }
           }/>
        {this.state.nameCheckIndicator&&
        <View>{
          this.state.nameCheckLoad?<ActivityIndicator size="large" color="green" />:
          <AntDesign style={{marginTop: 2, marginRight: 3}} name={'check'} size={40} color={'green'}></AntDesign>
        }</View>
        }
      </View>
        ...
        <View style={{flexDirection:'column'}}>
          <View style={{flexDirection:'row', alignItems:'baseline',}}> 
              ...
              underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={Keyword1} onChangeText={this.Keyword1Change}/>
              <TextInput style={styles.subTextinStyle} placeholder={'Edit Keyword 2'} 
              underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={Keyword2} onChangeText={this.Keyword2Change}/>
              <TextInput style={styles.subTextinStyle} placeholder={'Edit Keyword 3'} 
              underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={Keyword3} onChangeText={this.Keyword3Change}/>
          </View>
        ...
        <TextInput style={styles.subTextinStyle} placeholder={'Change City'}
         underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={City} onChangeText={this.CityChange}/>

        <TextInput style={styles.subTextinStyle} placeholder={'Change Province'}
         underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={Province} onChangeText={this.ProvinceChange}/>
      
      
        <TextInput style={styles.subTextinStyle} placeholder={'Change Country'} 
        underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={Country} onChangeText={this.CountryChange}/>
        </View>
        ...
        {/* <Text>{this.props.RootStore.UserName}</Text> */}
