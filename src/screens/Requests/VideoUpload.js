...
return (
    ...
    <TextInput style={[styles.inputStyle,{marginLeft:40}]} placeholder={'VideoName'} underlineColorAndroid={'transparent'} keyboardType={'email-address'} value={name} onChangeText={text=>{setName(text)}}/>
    </View>

    <Text>  </Text>
    <View style={{flexDirection:'row'}}> 
    <Text style={[styles.textstyle,{borderWidth:0}]}> Keywords: </Text>
    <TextInput style={styles.subTextinStyle} placeholder={'Keyword 1'} underlineColorAndroid={'transparent'} onChangeText={text=>{setKey1(text)}} keyboardType={'email-address'}/>
    <TextInput style={styles.subTextinStyle} placeholder={'Keyword 2'} underlineColorAndroid={'transparent'} onChangeText={text=>{setKey2(text)}} keyboardType={'email-address'}/>
    <TextInput style={styles.subTextinStyle} placeholder={'Keyword 3'} underlineColorAndroid={'transparent'} onChangeText={text=>{setKey3(text)}} keyboardType={'email-address'}/>
    </View>
    ...
    <TextInput style={styles.inputStyle} placeholder={'Description'}
     underlineColorAndroid={'transparent'} keyboardType={'email-address'} onChangeText={text=>{setShort(text)}}/>
    </View>
